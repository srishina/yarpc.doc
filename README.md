...
3. Easy usage in browser environment, i.e the system should be easy to depoly/use without forcing any extra indrection or proxying. for e.g gRPC client in the browser requires a proxy due to the usage of HTTP/2
